...
const links = [
  { href: '/saas-dev', text: 'SaaS Development' },
  { href: '/products', text: 'Our Products' },
  { href: '/user-flow', text: 'User Flow' },
  { href: '/user-strategey', text: 'User Strategy' },
];
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
            <div className="mb-10 w-full">
              ...
              <div className="mb-6 flex items-center">
                ...
                <Link
                  href="https:///www.twitter.com/luseratech"
                  className="text-dark hover:bg-primary hover:border-primary mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
                >
                  <svg
                    width={16}
              ...
              <Link
                href="https://www.luseratech.com/"
                className="text-body-color text-base"
              >
                Copyright © 2023 Lusera Tech
              </Link>
            </div>
          </div>
        </div>
